...
L["All realms will be displayed"] = "Afficher tous les royaumes"
L["/ap"] = true
...
L["|cff00ffffSeen |cffffffff%s |cff00ffffago|r"] = "|cff00ffffVu il y a |cffffffff%s|r"
L["Close"] = "Fermer"
...
L["Display the gold each character possesses"] = "Voir total Or avec tous ses persos"
L["Display the played time and the total time played"] = "Afficher le temps joué et le total"
L["Display the %s each character possesses"] = "Affiche les %s de chaque personnage"
...
-- L["Erase character data permanently"] = ""
...
L["Use the current sort type in reverse order"] = "Inverser l'ordre de tri"
